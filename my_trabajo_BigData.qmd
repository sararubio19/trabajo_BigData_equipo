---
title: "Análisis de la inflación en España 2002 2025"
description: |
  Un estudio de la evolución del Índice de Precios de Consumo (IPC) en las comunidades autónomas españolas (Base 2002 = 100)
  
author:   
  - García Martinez, Jaume\n 
  - Rubio Rosell, Sara (saruro@alumni.uv.es) \n
  - Sanz Miquel, Isabel
  
date: 00-12-2025               
categories: [trabajo BigData, inflación, españa] 

image: "https://e01-elmundo.uecdn.es/assets/multimedia/imagenes/2022/09/14/16631707118193.jpg"
title-block-banner: "#0e3b1e"
...
format: 
  html:
    ...
    #ss: assets/my_css_file.css   #- CUIDADO!!!!
code-tools: true
code-link: true
---
...
Este trabajo analiza la *evolución de la inflación* en España desde 2002 hasta 2025, con especial foco en las diferencias entre comunidades autónomas (CCAA). 
En los últimos años, destacando la crisis del covid-19 y la energética, la creciente inflación se ha convertido en un debate público fruto de la creciente preocupación social y en el punto de mira de las [decisisones de las instituciones](https://es.investing.com/news/economy-news/el-bce-en-buena-posicion-con-la-inflacion-cerca-del-objetivo-dicen-los-responsables-de-la-politica-monetaria-93CH-3407242).
El ✨objetivo principal✨ de este trabajo es mostrar la evolución de la inflación, desgranando las divergencias que se encuentran en las distintas comunidades autónomas así como también el impacto y las implicaciones producidas. En suma, explicar las causas y consecuencias económicas de este aumento de precios y del descontento general en España, dónde no se escapa ninguna población aislada (ni Pancrudo 😆).
...
Hemos cargado los paquetes necesarios para manipulación de datos (tidyverse), visualización (ggplot2), creación de tablas (gt, gtExtras) y mapas (sf, mapSpain). Los datos brutos del INE contienen información mensual del IPC por CCAA que procedemos a limpiar y transformar.

------------------------------------------------------------------------

## Descargar, limpiar, ordenar y transformar datos
...
Convertimos datos mensuales a anuales eliminando las referencias mensuales (M01, M02, etc.) Estandarizamos nombres de comunidades autónomas y corregimos carácteres especiales y notación decimal. Por último, convertimos variables a formatos numéricos.

------------------------------------------------------------------------

## Construcción del índice base 2002
...
El gráfico muestra que, aunque todas las Comunidades Autónomas comparten una tendencia creciente del IPC a lo largo del período 2002–2025, la intensidad del aumento no es uniforme. Tras partir todas del mismo valor en el año base 2002, las trayectorias comienzan a separarse progresivamente, especialmente en los años más recientes.
Hasta la crisis financiera de 2008, las diferencias entre comunidades son limitadas y las curvas presentan una evolución muy similar. Posteriormente, y de forma más marcada desde 2021, se observa una mayor dispersión entre regiones, reflejando un impacto desigual del repunte inflacionario reciente.
En el último año del período analizado (2025), algunas Comunidades Autónomas alcanzan niveles del IPC claramente superiores a la media nacional, mientras que otras se sitúan en posiciones relativamente más moderadas. Las etiquetas incorporadas en el gráfico permiten identificar la posición relativa de cada territorio y facilitan la comparación entre Comunidades Autónomas.
...
Este gráfico muestra la comparativa la inflación acumulada de España con Europa y la Unión Europea para el mismo periodo analizado. Los países que han empezado siendo pobres y han acabado casi convergiendo, como es el caso de Rumanía o Hungría, han reportado una mayor inflación que el resto de Europa. España, para nuestro caso, ha reportado una inflación menor que la media de la Unión Europea.
...
El salario real, que al fin y al cabo es el salario que perciben los trabajadores pero ajustados por inflación,  mide el poder adquisitivo de estos. Obviamente, el salario real tomará valores positivos cuando los salarios reales se incrementen por encima de la inflación y viceversa. Observamos un aumento del salario real en el periodo post crisis debido a la baja inflación reportada en algunos años, mientras la llegada de la actual década, el salario real ha caído en gran proporción, fruto del shock inflacionista.
...
## 7.1 Modelo ARIMA y predicción de la inflación
